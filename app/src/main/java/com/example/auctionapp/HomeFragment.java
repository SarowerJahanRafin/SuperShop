...
//        builder.setTitle("Add Item");
        ...
        final EditText itemAuctionTotalAmountEditText = viewInflated.findViewById(R.id.editProductAmount);
        ...
        builder.setPositiveButton("Add", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                String itemTotalAmountString = itemAuctionTotalAmountEditText.getText().toString();
                Float itemAmount = Float.valueOf(itemTotalAmountString);

                if(itemName.equals("")){
                    Toast.makeText(context, "Please enter an item name", Toast.LENGTH_SHORT).show();
                    return;
                }
                if(itemTotalAmountString.equals("")){
                    Toast.makeText(context, "Please enter an item amount", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (!itemName.isEmpty()) {
                    ...
                    Item newItem = new Item(itemName, itemDescription, itemPriceFloat,itemAmount,  currentTime, final_uri, category_Item, itemAuctionTimeTotalInSeconds);
